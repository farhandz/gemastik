...
export default function Footer({activePath}) {
  ...
  return (
    <>
    <div className="fixed bottom-3 left-1/2 transform -translate-x-1/2 text-center w-screen d-none justify-items-center h-16  border-gray-200 dark:bg-gray-700 dark:border-gray-600">
          <div className="grid bg-white border-t  h-full max-w-lg grid-cols-4 mx-auto font-medium">
              ...
              <a type="a"  href="/kamera" className="inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group">
