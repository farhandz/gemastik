...
export default function Footer({activePath}) {
  ...
  return (
    <>
    <div className="fixed bottom-0 left-1/2 transform -translate-x-1/2 text-center w-full  justify-items-center h-16  border-gray-200 dark:bg-gray-700 dark:border-gray-600">
          <div className="grid bg-white border-t  h-full max-w-lg grid-cols-4  font-medium">
